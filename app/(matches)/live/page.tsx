                ...
                .map(([leagueName, leagueMatches]) => (
                    <div key={leagueName} className="mb-8">
                        <div className="flex items-center mb-4">
                            <Link href={`/international/teams/${leagueMatches[0].league.country}`}><img
                                src={leagueMatches[0].league.flag} alt="" className="w-6 h-4 mr-2"/></Link>
                            <Link href={`/leagues/${leagueName}-${leagueMatches[0].league.id}`}><h2
                                className="text-xl font-bold text-primary">{leagueName}</h2></Link>
                        </div>
                                    ...
                                    <div className="p-2 flex flex-col justify-between">
                                        <div className="flex justify-between items-end">
                                            <div className="flex items-center space-x-2">
                                                <Link href={`/teams/aston-villa-66`}><img src={match.teams.home.logo} alt=""
                                            ...
                                            <div className="flex items-center space-x-2 justify-end">
                                                ...
                                                <Link href={`/`}><img src={match.teams.away.logo} alt=""
                                                                      className="w-8 h-8 md:hidden lg:block"/></Link>
